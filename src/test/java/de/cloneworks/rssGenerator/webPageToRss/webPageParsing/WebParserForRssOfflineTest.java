...
@SpringBootTest
public class WebParserForRssOfflineTest {
	...
	public void readItemsFromHtml() throws InvalidParameterException {
		...
		Iterator<RssDataItem> itemIterator = subject.iterator();
		RssDataItem item1 = itemIterator.next();
		...
		RssDataItem item2 = itemIterator.next();
		...
		RssDataItem item3 = itemIterator.next();
		...
		RssDataItem item4 = itemIterator.next();
		...
		RssDataItem item5 = itemIterator.next();
		...
		RssDataItem item6 = itemIterator.next();
		...
		RssDataItem item7 = itemIterator.next();
		...
		RssDataItem item8 = itemIterator.next();
		...
		RssDataItem item9 = itemIterator.next();
