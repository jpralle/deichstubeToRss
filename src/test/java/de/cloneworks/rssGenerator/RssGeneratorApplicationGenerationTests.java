...
@SpringBootTest(classes = RssGeneratorApplication.class, webEnvironment= WebEnvironment.RANDOM_PORT)
@AutoConfigureMockMvc
public class RssGeneratorApplicationGenerationTests {
	...
	public void testIndex() throws Exception {
		...
		assertThat(content, containsString("<h1>Deichstube News RSS</h1>"));
